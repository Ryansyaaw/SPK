    ...
    <div class="items-center block w-auto max-h-screen overflow-auto h-sidenav grow basis-full">
        <ul class="flex flex-col pl-0 mb-0">
            <li class="mt-0.5 w-full">
                <a  class="{{ Request::is('/') ? 'active':'' }}  dark:text-white dark:opacity-80 py-2.7 text-sm ease-nav-brand my-0 mx-2 flex items-center whitespace-nowrap px-4 transition-colors "
                    href="{{route('home.index')}}">
                    <div
            ...
            <li class="mt-0.5 w-full">
                <a class="{{ Request::is('criteria') ? 'active':'' }}  dark:text-white dark:opacity-80 py-2.7 text-sm ease-nav-brand my-0 mx-2 flex items-center whitespace-nowrap px-4 transition-colors"
            ...
            <li class="mt-0.5 w-full">
                <a class="{{ Request::is('alternatif') ? 'active':'' }}  dark:text-white dark:opacity-80 py-2.7 text-sm ease-nav-brand my-0 mx-2 flex items-center whitespace-nowrap px-4 transition-colors"
            ...
            <li class="mt-0.5 w-full">
                <a class="{{ Request::is('penilaian') ? 'active':'' }}  dark:text-white dark:opacity-80 py-2.7 text-sm ease-nav-brand my-0 mx-2 flex items-center whitespace-nowrap px-4 transition-colors"
            ...
            <li class="mt-0.5 w-full">
                <a class="{{ Request::is('perhitungan') ? 'active':'' }}  dark:text-white dark:opacity-80 py-2.7 text-sm ease-nav-brand my-0 mx-2 flex items-center whitespace-nowrap px-4 transition-colors"
