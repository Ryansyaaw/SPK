                                ...
                                @foreach ($alternatif as $a)
                                    <tr>
                                        ...
                                        <td
                                            ...
                                            <button type="button" data-modal-target="add-criterias-{{ $a->id }}"
                                        ...
                                        <div id="add-criterias-{{ $a->id }}" tabindex="-1" aria-hidden="true"
                                            ...
                                            <div class="relative p-4 w-full max-w-md max-h-full">
                                                ...
                                                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                                    ...
                                                    <!-- Modal body -->
                                                    <form class="mx-3 p-4 md:p-5" id="add-criterias-{{ $a->id }}"
                                                        action="{{ route('penilaian.store') }}" method="POST">
                                                        @csrf
                                                        <div class="mx-2 grid gap-4 mb-4 grid-cols-2">
                                                            <input type="text" name="id_alternatif" hidden
                                                                value="{{ $a->id }}">
                                                            @foreach ($criteria as $c)
                                                                <div class="col-span-2 sm:col-span-1">
                                                                    <label for="nilai_{{ $c->id }}"
    ...
    <div class="flex flex-wrap -mx-3">
        <div class="flex-none w-full max-w-full px-3 overflow-x-hidden">
            <div class="relative flex flex-col min-w-0 mb-6 break-words bg-white border-0 border-transparent border-solid shadow-xl dark:bg-slate-850 dark:shadow-dark-xl rounded-2xl bg-clip-border">
                <div class="flex justify-between p-6 pb-0 mb-0 border-b-0 border-b-solid rounded-t-2xl border-b-transparent">
                    <h6 class="dark:text-white">Ranking</h6>
                </div>
                <div class="flex-auto px-0 pt-0 pb-2">
                    <div class="p-6 overflow-x-auto">
